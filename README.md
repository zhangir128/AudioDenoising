...
# Personal Recordings
The recording was made with a background noise of washine machine and the denoised file is the desired output. The audio files have been included in the recordings folder in this repository.
